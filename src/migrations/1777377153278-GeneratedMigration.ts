...
export class GeneratedMigration1777377153278 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TABLE "comments" ("id" SERIAL NOT NULL, "body" text NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "articleId" integer, "authorId" integer, CONSTRAINT "PK_8bf68bc960f2b69e818bdb90dcb" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "articles" ("id" SERIAL NOT NULL, "slug" character varying NOT NULL, "title" character varying NOT NULL, "description" character varying NOT NULL DEFAULT '', "body" text NOT NULL DEFAULT '', "tagList" text NOT NULL DEFAULT '', "favoriteCount" integer NOT NULL DEFAULT '0', "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "authorId" integer, CONSTRAINT "UQ_1123ff6815c5b8fec0ba9fec370" UNIQUE ("slug"), CONSTRAINT "PK_0a6e2c450d83e0b6052c2793334" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "user_favorites_articles" ("userId" integer NOT NULL, "articlesId" integer NOT NULL, CONSTRAINT "PK_2fa8a5bd94301a2985b59f5d397" PRIMARY KEY ("userId", "articlesId"))`,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_81b77658546f148f69db2e7a48" ON "user_favorites_articles" ("userId") `,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_aa78cf32d784957ec6ae8b1943" ON "user_favorites_articles" ("articlesId") `,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "comments" ADD CONSTRAINT "FK_4548cc4a409b8651ec75f70e280" FOREIGN KEY ("authorId") REFERENCES "user"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "user_favorites_articles" ADD CONSTRAINT "FK_81b77658546f148f69db2e7a487" FOREIGN KEY ("userId") REFERENCES "user"("id") ON DELETE CASCADE ON UPDATE CASCADE`,
    );
    await queryRunner.query(
      `ALTER TABLE "user_favorites_articles" ADD CONSTRAINT "FK_aa78cf32d784957ec6ae8b19436" FOREIGN KEY ("articlesId") REFERENCES "articles"("id") ON DELETE CASCADE ON UPDATE CASCADE`,
    );
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "user_favorites_articles" DROP CONSTRAINT "FK_aa78cf32d784957ec6ae8b19436"`,
    );
    await queryRunner.query(
      `ALTER TABLE "user_favorites_articles" DROP CONSTRAINT "FK_81b77658546f148f69db2e7a487"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `DROP INDEX "public"."IDX_aa78cf32d784957ec6ae8b1943"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_81b77658546f148f69db2e7a48"`,
    );
